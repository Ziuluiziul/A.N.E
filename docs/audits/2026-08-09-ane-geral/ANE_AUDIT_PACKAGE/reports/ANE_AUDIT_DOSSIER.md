...
[OBSERVADO] Há 22 caminhos `$USER_HOME` em nove documentos, caminhos de backup pessoal,
...
- **Reprodução:** `find` dos arquivos de publicação, `rg -l '$USER_HOME'`, soma de bytes rastreados.
